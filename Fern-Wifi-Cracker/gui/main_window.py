...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.attack_options_button = QtGui.QPushButton(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("%s/resources/wifi_4.png"%(os.getcwd()))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.attack_options_button.setIcon(icon7)
        #self.attack_options_button.setIconSize(QtCore.QSize(48, 49))
        self.attack_options_button.setIconSize(QtCore.QSize(67, 62))
        self.attack_options_button.setObjectName(_fromUtf8("attack_options_button"))
        self.verticalLayout_16.addWidget(self.attack_options_button)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.attack_options_button.setText(QtGui.QApplication.translate("Dialog", "WIFI Attack Options", None, QtGui.QApplication.UnicodeUTF8))
